...
console.log('Runtime theme contract passed: short labels, path-safe v6 tokens, glow/finish/pattern/segmented-inlay textures, v1-v5 compatibility including visual preservation, canonical mesh reuse, safe SVG, and mechanics-field rejection are protected.');
