...
assert.equal(command('d100', 90).text, 'MAX');
...
console.log('DiceBox glyph plan passed: canonical labels, short custom artwork, percentile faces, and d4 markings stay visual-only.');
