...
import { indexRawCatalog, validateRawCatalog } from './catalog.mjs';
...
export const RAW_CATALOG_INDEXES = Object.freeze({
  'dnd5e-2014': indexRawCatalog(RAW_2014),
  'dnd5e-2024': indexRawCatalog(RAW_2024),
});
