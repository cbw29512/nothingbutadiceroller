...
export const RAW_2014 = Object.freeze([
  makeRawSpell({
    ruleset: RULESET, srdVersion: SRD, spellId: 'acid-arrow', name: 'Acid Arrow', spellLevel: 2,
    scalingMode: 'slot', icon: 'spark', sourceLocator: 'SRD 5.1 Spell Descriptions: Acid Arrow',
  ...
  makeRawSpell({
    ...
    scalingMode: 'cantrip-tier', icon: 'potion', sourceLocator: 'SRD 5.1 Spell Descriptions: Acid Splash',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'flame', sourceLocator: 'SRD 5.1 Spell Descriptions: Burning Hands',
  ...
  makeRawSpell({
    ...
    scalingMode: 'cantrip-tier', icon: 'flame', sourceLocator: 'SRD 5.1 Spell Descriptions: Fire Bolt',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'flame', sourceLocator: 'SRD 5.1 Spell Descriptions: Fireball',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'star', sourceLocator: 'SRD 5.1 Spell Descriptions: Guiding Bolt',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'bolt', sourceLocator: 'SRD 5.1 Spell Descriptions: Lightning Bolt',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'spark', sourceLocator: 'SRD 5.1 Spell Descriptions: Magic Missile',
    variants: magicMissileVariants(),
  }),
  makeRawSpell({
    ruleset: RULESET, srdVersion: SRD, spellId: 'ray-of-frost', name: 'Ray of Frost', spellLevel: 0,
    scalingMode: 'cantrip-tier', icon: 'frost', sourceLocator: 'SRD 5.1 Spell Descriptions: Ray of Frost',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'sun', sourceLocator: 'SRD 5.1 Spell Descriptions: Scorching Ray',
    variants: scorchingRayVariants(), requiresToHit: true,
  }),
  makeRawSpell({
    ruleset: RULESET, srdVersion: SRD, spellId: 'shatter', name: 'Shatter', spellLevel: 2,
    scalingMode: 'slot', icon: 'spark', sourceLocator: 'SRD 5.1 Spell Descriptions: Shatter',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'bolt', sourceLocator: 'SRD 5.1 Spell Descriptions: Thunderwave',
  ...
  makeRawSpell({
    ...
    scalingMode: 'slot', icon: 'spark', sourceLocator: 'SRD 5.1 Spell Descriptions: Disintegrate',
  ...
  makeRawSpell({
    ...
    scalingMode: 'fixed', icon: 'skull', sourceLocator: 'SRD 5.1 Spell Descriptions: Harm',
